...
// //               polyline: {
// //                 points:
// //                   "a|olEl}}mUv@wAVIh@LBBX^FFT`A?T?FL@fADCrAGhBG`AANGz@Iz@OrAOlACPALKf@SfAOv@EN]rAJHFDJHENM^a@rAc@lAw@fBKXk@jA_@r@c@t@W`@IL[d@g@r@{@fAKLsBfCIJi@p@o@`AOVQZS`@]x@o@vA{BfF}@dBk@`Au@dACBMP]`@EHc@h@KJEDIJoBjB]\\m@t@_@`@W\\_@f@Yd@]h@ILIPILrApA",
// //               },
// //               start_location: {
// //                 lat: 33.6737715,
// //                 lng: -117.7955883,
...
// //                   },
// //                   html_instructions:
// //                     "Turn \u003cb\u003eleft\u003c/b\u003e toward \u003cb\u003eAlton Pkwy\u003c/b\u003e",
// //                   maneuver: "turn-left",
// //                   polyline: {
// //                     points: "}uolEf_~mUfAD",
// //                   },
...
// //                   },
// //                   html_instructions:
// //                     "Turn \u003cb\u003eright\u003c/b\u003e onto \u003cb\u003eAlton Pkwy\u003c/b\u003e",
// //                   maneuver: "turn-right",
// //                   polyline: {
// //                     points:
// //                       "usolEl_~mUCrAGhBG`AANGz@Iz@OrAOlACPALKf@SfAOv@EN]rAJH",
// //                   },
// //                   start_location: {
// //                     lat: 33.6724256,
// //                     lng: -117.7959147,
...
// //                   },
// //                   html_instructions:
// //                     "Turn \u003cb\u003eleft\u003c/b\u003e onto \u003cb\u003eCreek Rd\u003c/b\u003e",
// //                   maneuver: "turn-left",
// //                   polyline: {
...
// //                   polyline: {
// //                     points:
// //                       "}wolEl{~mUM^a@rAc@lAw@fBKXk@jA_@r@c@t@W`@IL[d@g@r@{@fAKLsBfCIJi@p@o@`AOVQZS`@]x@o@vA{BfF}@dBk@`Au@dACBMP]`@EHc@h@KJEDIJoBjB]\\m@t@_@`@W\\_@f@Yd@]h@ILIPIL",
// //                   },
// //                   start_location: {
// //                     lat: 33.6731102,
// //                     lng: -117.8003862,
...
// //                   },
// //                   html_instructions:
// //                     'Turn \u003cb\u003eleft\u003c/b\u003e onto \u003cb\u003eCulver Dr\u003c/b\u003e\u003cdiv style="font-size:0.9em"\u003eDestination will be on the right\u003c/div\u003e',
// //                   maneuver: "turn-left",
// //                   polyline: {
...
// //               },
// //               html_instructions:
// //                 "Walk to 6210, Donald Bren Hall, Irvine, CA 92697, USA",
// //               polyline: {
// //                 points:
// //                   "qcklEzqfnUBEJQDIECGCGAGC@LJ@NNHFHFJJDD\\VZXd@Qf@d@JHDKR]PNHHR]\\u@DK@A@?@?B@HDNJZXJBFGFKLNBDDHLKf@]NK`@QTMPE`@Kj@A`@?H?|@Lh@LVJFJHDVNHDJHZVNV`@d@Z\\RVLHJPRf@@H?FBJFNHLJBFHb@pAB?FBF?FAFAFETV",
// //               },
// //               start_location: {
// //                 lat: 33.6493654,
// //                 lng: -117.8398221,
...
// //                   },
// //                   html_instructions:
// //                     "Head \u003cb\u003esoutheast\u003c/b\u003e on \u003cb\u003eCampus Dr\u003c/b\u003e",
// //                   polyline: {
...
// //                   },
// //                   html_instructions:
// //                     'Turn \u003cb\u003eleft\u003c/b\u003e toward \u003cb\u003ePereira Dr\u003c/b\u003e\u003cdiv style="font-size:0.9em"\u003eTake the stairs\u003c/div\u003e',
// //                   maneuver: "turn-left",
// //                   polyline: {
...
// //                   },
// //                   html_instructions:
// //                     "Sharp \u003cb\u003eleft\u003c/b\u003e toward \u003cb\u003ePereira Dr\u003c/b\u003e",
...
// //                   },
// //                   html_instructions:
// //                     "Turn \u003cb\u003eleft\u003c/b\u003e toward \u003cb\u003ePereira Dr\u003c/b\u003e",
// //                   maneuver: "turn-left",
// //                   polyline: {
// //                     points: "{_klE~sfnUd@Q",
// //                   },
...
// //                   },
// //                   html_instructions:
// //                     "Turn \u003cb\u003eright\u003c/b\u003e toward \u003cb\u003ePereira Dr\u003c/b\u003e",
// //                   maneuver: "turn-right",
// //                   polyline: {
...
// //                   },
// //                   html_instructions:
// //                     "Turn \u003cb\u003eleft\u003c/b\u003e onto \u003cb\u003ePereira Dr\u003c/b\u003e",
// //                   maneuver: "turn-left",
// //                   polyline: {
...
// //                   },
// //                   html_instructions:
// //                     "Turn \u003cb\u003eright\u003c/b\u003e toward \u003cb\u003eRing Rd\u003c/b\u003e",
// //                   maneuver: "turn-right",
// //                   polyline: {
...
// //                   },
// //                   html_instructions:
// //                     "Turn \u003cb\u003eleft\u003c/b\u003e toward \u003cb\u003eRing Rd\u003c/b\u003e",
// //                   maneuver: "turn-left",
// //                   polyline: {
...
// //                   },
// //                   html_instructions:
// //                     'Turn \u003cb\u003eleft\u003c/b\u003e onto \u003cb\u003eRing Rd\u003c/b\u003e\u003cdiv style="font-size:0.9em"\u003eTake the stairs\u003c/div\u003e',
// //                   maneuver: "turn-left",
// //                   polyline: {
// //                     points:
// //                       "_vjlEhsfnULKf@]NK`@QTMPE`@Kj@A`@?H?|@Lh@LVJFJHDVNHDJHZVNV`@d@Z\\RVLHJPRf@@H?FBJFNHL",
// //                   },
// //                   start_location: {
// //                     lat: 33.647205,
// //                     lng: -117.8400535,
...
// //                   },
// //                   html_instructions:
// //                     "Slight \u003cb\u003eleft\u003c/b\u003e to stay on \u003cb\u003eRing Rd\u003c/b\u003e",
...
// //     {
// //       "geocoder_status": "OK",
// //       "place_id": "Ei1BbHRvbiBQa3d5ICYgQ3VsdmVyIERyLCBJcnZpbmUsIENBIDkyNjA2LCBVU0EiZiJkChQKEgkL_9fMNNzcgBFwBez8iAz4RRIUChIJC__XzDTc3IARcAXs_IgM-EUaFAoSCSk-1B0J3dyAEbUcJIA0_iPPGhQKEgkPzwUtVdzcgBEswWSQvwwkuyIKDXBKExQVgGrHuQ",
// //       "types": [
// //         "intersection"
// //       ]
// //     }
...
// //             "value": 339
// //           },
// //           "end_address": "Alton Pkwy & Culver Dr, Irvine, CA 92606, USA",
// //           "end_location": {
// //             "lat": 33.680856,
// //             "lng": -117.8113408
// //           },
...
// //               "maneuver": "turn-right",
// //               "polyline": {
// //                 "points": "msolEf_~mUExAEhB?@G`AANGx@I|@?BOnASvACTIf@UfAOv@EN_@|AKZMf@[bA]z@]~@Uh@]t@m@lA]l@ILMRm@`AiA~A_CtCm@t@m@x@_@f@[f@MVINAB_@r@_AvBeAbC[r@_@~@OVWd@?@Yf@a@p@U\\q@|@[`@s@v@GHIFaC`CA@u@r@CBa@d@ORY`@QTYd@]j@"
// //               },
// //               "start_location": {
// //                 "lat": 33.672387,
// //                 "lng": -117.795875
...
// //       ],
// //       "overview_polyline": {
// //         "points": "qvolEz|}mULh@AVvAHExAEjBIpAa@jEWlB_@nBaA`Ei@jB{@zBs@~AkAzBW`@wB`DmDjEmA`Bu@rAaEbJgA~B{@xAgAzAaBjB}DzDq@x@k@v@w@pA"
// //       },
// //       "summary": "Alton Pkwy",
// //       "warnings": [
